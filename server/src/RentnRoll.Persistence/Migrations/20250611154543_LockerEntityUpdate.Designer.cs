...
namespace RentnRoll.Persistence.Migrations
{
    ...
    [Migration("20250611154543_LockerEntityUpdate")]
    partial class LockerEntityUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentnRoll.Domain.Entities.Lockers.Locker", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Address", "RentnRoll.Domain.Entities.Lockers.Locker.Address#Address", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("RentnRoll.Domain.Entities.Lockers.Locker", b =>
                {
                    b.OwnsMany("RentnRoll.Domain.Entities.Lockers.Cell", "Cells", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uniqueidentifier");

                            b1.Property<Guid?>("BusinessGameId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<Guid?>("BusinessId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<string>("IotDeviceId")
                                .HasMaxLength(100)
                                .HasColumnType("varchar(100)");
                            ...
                            b1.HasIndex("BusinessGameId");

                            b1.HasIndex("BusinessId");

                            b1.HasIndex("LockerId");

                            b1.ToTable("Cell");

                            b1.HasOne("RentnRoll.Domain.Entities.BusinessGames.BusinessGame", "BusinessGame")
                                .WithMany()
                                .HasForeignKey("BusinessGameId");

                            b1.HasOne("RentnRoll.Domain.Entities.Businesses.Business", "Business")
                                .WithMany()
                                .HasForeignKey("BusinessId");
                            ...
                            b1.Navigation("BusinessGame");

                            b1.Navigation("Locker");
                        });
            ...
            modelBuilder.Entity("RentnRoll.Domain.Entities.PricingPolicies.PricingPolicy", b =>
                {
                    ...
                    b.OwnsMany("RentnRoll.Domain.Entities.PricingPolicies.PricingPolicyItem", "Items", b1 =>
                        {
                            ...
                            b1.HasKey("PolicyId", "GameId");

                            b1.HasIndex("GameId");

                            b1.ToTable("PricingPolicyItem");

                            b1.HasOne("RentnRoll.Domain.Entities.BusinessGames.BusinessGame", "Game")
                                .WithMany()
                                .HasForeignKey("GameId")
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired();
            ...
            modelBuilder.Entity("RentnRoll.Domain.Entities.Stores.Store", b =>
                {
                    ...
                    b.OwnsMany("RentnRoll.Domain.Entities.Stores.StoreAsset", "Assets", b1 =>
                        {
                            ...
                            b1.HasKey("StoreId", "BusinessGameId");

                            b1.HasIndex("BusinessGameId");

                            b1.ToTable("StoreAsset");
